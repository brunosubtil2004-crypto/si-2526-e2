...
a password de todas as keystores que temos é 123456.
...
java mySaudeServer <porta> (ex:4444), colocar a password do MAC asseguir é 123456


- Criar Utilizador (na pasta do servidor, já com o cert exportado na mesma pasta)
criarUser <user> <role> <pass> -f <cert>

- Diretorias do servidor
O servidor vem com 2 diretorias criadas já, nomeadamente Jose e Bruno prontas para testes, podem-se criar mais conforme necessário com o criarUser. 

- KeyStores
A KeyStore tem de estar ao mesmo nível do cliente para o mesmo a poder ler (dentro da pasta do cliente, temos algumas na pasta KeyStore, deixámos a Bruno pronta a utilizar).

------------
| Comandos | (executar dentro da pasta do cliente, a pass é 123456 para as keystores e para os users criados no servidor que deixamos Jose e Bruno)
------------

- Enviar e receber ficheiros do cliente para o servidor
java mySaude -s endereço:porto_do_servidor -u username -p 123456 -e nomes_de_ficheiros -t username_do_destinatario
